...
file_temp = os.path.join(dir_temp, '../script_files/HK_Temperature.dat')
...
file_ENC = os.path.join(dir_ENC, '../script_files/ENC_normal.dat')
...
file_thr = os.path.join(dir_thr, '../script_files/Threshold_dispersion.dat')
